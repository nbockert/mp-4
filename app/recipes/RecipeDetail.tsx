...
import IngredientDisplay from '@/app/recipes/IngredientDisplay';
import WineDisplay from '@/app/recipes/WinePairing';




export default async function RecipeDetailPage({id}:{id:string}) {
    try{
